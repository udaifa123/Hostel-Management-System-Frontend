...
import { Drawer, List, ListItem, ListItemIcon, ListItemText, ListItemButton, Box, Typography, Divider, Avatar } from '@mui/material';
...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { text: 'Hostels', icon: <HostelIcon />, path: '/admin/hostels' },
    { text: 'Wardens', icon: <WardenIcon />, path: '/admin/wardens' },
