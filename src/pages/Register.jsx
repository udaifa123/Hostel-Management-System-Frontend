...
const Register = () => {
  ...
  const { register, login } = useAuth(); // Added login here
 ...
 const [formData, setFormData] = useState({
  ...
  const roles = [
    { 
      ...
      fields: ['rollNumber', 'course', 'semester', 'batch', 'dateOfBirth', 'gender', 'bloodGroup']
    },
    { 
      id: 'parent', 
      label: 'Parent', 
    ...
    { 
      ...
      description: 'Mark attendance & manage student records',
      fields: ['staffId', 'designation', 'workingHours']
    }
  ];
 ...
 const validateStep2 = () => {
  ...
  registrationData.parentEmail = formData.parentEmail; // ✅ ADD THIS
}
        ...
        registrationData.staffId = formData.staffId;
  ...
  const renderStaffFields = () => (
    <div className="role-fields">
      <h3 className="step-title">Staff Details</h3>
      <div className="form-grid">
        <div className="form-group">
