...
const Home = () => {
  ...
  // Removed selectedHostel and showHostelModal states
  ...
  const hostels = [
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dncdvsywu/image/upload/v1772706509/dorm5_rte4el.jpg",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1574369862763-2450e3e7c3b7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1551918120-9739cb430fd6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  const steps = [
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dncdvsywu/image/upload/v1772030425/configure_access_wthbr2.jpg",
      duration: "1 hour"
    },
    {
      number: "04",
      ...
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-hamburger {
          ...
          color: var(--emerald-d); cursor: pointer;
        ...
        .mob-overlay {
          ...
          background: rgba(15,31,20,0.55); backdrop-filter: blur(4px);
          opacity: 0; pointer-events: none; transition: opacity .3s;
        }
        .mob-overlay.open { opacity: 1; pointer-events: all; }
        .mob-panel {
          position: fixed; top: 0; right: -320px; bottom: 0; width: 300px; z-index: 1001;
        ...
        .hero-mesh {
          ...
          background:
            radial-gradient(ellipse 60% 50% at 15% 40%, rgba(5,150,105,0.12) 0%, transparent 60%),
            radial-gradient(ellipse 50% 40% at 85% 60%, rgba(13,148,136,0.1) 0%, transparent 60%),
            radial-gradient(ellipse 40% 30% at 50% 100%, rgba(217,119,6,0.06) 0%, transparent 50%);
        }
        .hero-dots {
          position: absolute; inset: 0; z-index: 0;
          background-image: radial-gradient(rgba(5,150,105,0.15) 1px, transparent 1px);
          background-size: 32px 32px;
          mask-image: radial-gradient(ellipse 80% 80% at 50% 50%, black 40%, transparent 100%);
        }
        .hero-leaf-1 {
          position: absolute; top: 12%; right: 5%; z-index: 0;
          width: 200px; height: 200px; border-radius: 60% 40% 60% 40% / 50% 60% 40% 50%;
          background: rgba(5,150,105,0.06);
          animation: leafSpin 8s ease-in-out infinite;
        }
        .hero-leaf-2 {
          position: absolute; bottom: 10%; left: 3%; z-index: 0;
          width: 140px; height: 140px; border-radius: 40% 60% 40% 60% / 60% 40% 60% 40%;
          background: rgba(13,148,136,0.07);
          animation: leafSpin 10s ease-in-out infinite 2s;
        }
        .hero-inner {
        ...
        .hero-h1 {
          ...
          font-weight: 900; letter-spacing: -1px; margin-bottom: 22px;
        ...
        .hero-cta {
          ...
          background: var(--gv); color: #fff; border: none; cursor: pointer;
          display: inline-flex; align-items: center; gap: 8px;
          transition: all .25s;
        ...
        .hero-img-tint {
          ...
          background: linear-gradient(135deg, rgba(5,150,105,0.03) 0%, rgba(13,148,136,0.02) 100%);
        }
        .hero-chip {
          position: absolute;
        ...
        .chip-icon {
          ...
          background: var(--gv); display: flex; align-items: center; justify-content: center;
          flex-shrink: 0;
        }
        ...
        .ticker-label {
          ...
          letter-spacing: 1.5px; color: var(--muted); text-transform: uppercase; margin-bottom: 18px;
        }
        ...
        .section-eyebrow {
          ...
          background: rgba(5,150,105,0.08); border: 1.5px solid rgba(5,150,105,0.2);
          font-size: 12px; font-weight: 800; letter-spacing: 1px;
          text-transform: uppercase; color: var(--emerald-d);
          margin-bottom: 18px;
          font-family: 'Nunito', sans-serif;
        }
        ...
        /* ── FEATURES — no overlay, no shadow on image ── */
        ...
        .feat-card:hover {
          ...
          box-shadow: 0 20px 40px rgba(164,186,179,0.12), 0 0 0 1px rgba(5,150,105,0.1);
        }
        ...
        .feat-badge {
          ...
          font-size: 12px; font-weight: 700; color: var(--emerald-d);
        ...
        .stats-band {
          padding: 72px 48px;
          background: linear-gradient(135deg, #0a1f14 0%, #0f2d1e 50%, #0a1f14 100%);
        ...
        .stats-band::before {
          ...
          background: radial-gradient(ellipse 80% 60% at 50% 50%, rgba(5,150,105,0.15) 0%, transparent 70%);
        }
        .stats-band-inner { max-width: 1280px; margin: 0 auto; position: relative; z-index: 2; }
        .stats-grid { display: grid; grid-template-columns: repeat(4,1fr); gap: 2px; }
        .stat-box {
          text-align: center; padding: 32px 20px;
          border: 1px solid rgba(5,150,105,0.15); border-radius: var(--r-lg);
        ...
        .stat-ico-wrap {
          ...
          display: flex; align-items: center; justify-content: center;
          margin: 0 auto 18px; color: var(--emerald-l);
        }
        ...
        /* ── PROCESS — no overlay, no shadow on image ── */
        ...
        .proc-num {
          ...
          color: rgba(5,150,105,0.06); line-height: 1; z-index: 1;
        }
        ...
        .price-card.hot {
          ...
          background: linear-gradient(145deg, rgba(5,150,105,0.04), var(--white));
          box-shadow: 0 0 0 1px rgba(5,150,105,0.15), var(--shadow-card);
        }
        ...
        .testi-card::before {
          ...
          font-size: 120px; font-family: 'Playfair Display',serif; font-weight: 900;
        ...
        .cta-band {
          padding: 96px 48px;
          background: linear-gradient(135deg, #062912 0%, #083d1c 50%, #062912 100%);
          border-top: 1px solid rgba(5,150,105,0.2);
          position: relative; overflow: hidden;
        }
        .cta-glow {
          position: absolute; inset: 0;
          background: radial-gradient(ellipse 70% 60% at 50% 50%, rgba(5,150,105,0.2) 0%, transparent 70%);
        }
        .cta-ring {
          position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%);
          width: 600px; height: 600px;
          border: 1px solid rgba(5,150,105,0.1); border-radius: 50%;
        }
        .cta-ring-2 {
          position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%);
          width: 900px; height: 900px;
          border: 1px solid rgba(5,150,105,0.05); border-radius: 50%;
        }
        ...
        .cta-badge {
          ...
          font-size: 12px; font-weight: 800; letter-spacing: 1px; text-transform: uppercase; color: var(--emerald-l);
          font-family: 'Nunito', sans-serif;
        }
        ...
        .cta-btn-p {
          ...
          background: var(--emerald-l); border: none; cursor: pointer;
        ...
        .cta-btn-s {
          ...
          background: transparent; border: 1.5px solid rgba(5,150,105,0.4); cursor: pointer;
          transition: all .25s; font-family: 'Nunito', sans-serif;
        }
        ...
        .contact-ico-wrap {
          ...
          background: rgba(5,150,105,0.08); border: 1.5px solid rgba(5,150,105,0.15);
          display: flex; align-items: center; justify-content: center;
          margin: 0 auto 20px; color: var(--emerald);
        }
        ...
        .footer-social-btn {
          ...
          background: rgba(5,150,105,0.08); border: 1px solid rgba(5,150,105,0.15);
          display: flex; align-items: center; justify-content: center;
          color: rgba(255,255,255,0.4); transition: all .2s; cursor: pointer;
        }
        ...
        .footer-input {
          ...
          border: 1px solid rgba(5,150,105,0.2); background: rgba(5,150,105,0.06);
        ...
        .footer-sub-btn {
          ...
          background: var(--gv); border: none; color: #fff;
        ...
        .hostels-section { padding: 96px 48px; background: var(--bg-2); }
        .hostels-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-top: 52px; }
        .hostel-card {
        ...
        .hostel-card:hover { transform: translateY(-6px); border-color: rgba(5,150,105,0.4); box-shadow: 0 20px 40px rgba(5,150,105,0.12); }
        .hostel-card-img { height: 160px; overflow: hidden; }
        .hostel-card-img img { width: 100%; height: 100%; object-fit: cover; transition: transform .6s; }
        .hostel-card:hover .hostel-card-img img { transform: scale(1.08); }
        .hostel-card-body { padding: 20px; }
        .hostel-card-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; }
        .hostel-card-name { font-size: 16px; font-weight: 800; color: var(--ink); font-family: 'Playfair Display', serif; }
        .hostel-card-type { font-size: 11px; font-weight: 700; padding: 3px 8px; background: rgba(5,150,105,0.1); color: var(--emerald-d); border-radius: 100px; }
        .hostel-card-location { display: flex; align-items: center; gap: 4px; font-size: 12px; color: var(--muted); margin-bottom: 12px; }
        .hostel-card-stats { display: flex; gap: 16px; margin-bottom: 12px; }
        .hostel-card-stat { display: flex; align-items: center; gap: 4px; font-size: 12px; color: var(--ink-2); }
        .hostel-card-progress { height: 4px; background: #e2e8f0; border-radius: 100px; overflow: hidden; margin: 12px 0; }
        .hostel-card-progress-fill { height: 100%; background: var(--gv); border-radius: 100px; }
        .hostel-card-footer { display: flex; justify-content: space-between; align-items: center; }
        .hostel-card-price { font-size: 14px; font-weight: 700; color: var(--emerald-d); }
        .hostel-card-link { font-size: 12px; font-weight: 600; color: var(--muted-2); display: flex; align-items: center; gap: 4px; }

        @media (max-width: 1200px) {
          .feat-grid, .hostels-grid { grid-template-columns: repeat(2,1fr); }
        ...
        @media (max-width: 768px) {
          ...
          .feat-grid, .proc-grid, .pricing-grid, .contact-grid, .hostels-grid { grid-template-columns: 1fr; }
        ...
        <div className="hero-inner">
          <div>
            ...
            <div className="hero-actions fade-up delay-3">
              <Link to="/register" className="hero-cta">Get Started Free <ArrowRight size={16}/></Link>
              <a href="#demo" className="hero-demo"><Play size={16}/> Watch Demo</a>
            </div>
      ...
      <section className="hostels-section" id="hostels">
        <div className="section-inner">
          <div className="section-head-center">
            <div className="section-eyebrow">🏨 Our Hostels</div>
            <h2 className="section-h2">Choose Your <span className="grad">Perfect Stay</span></h2>
            <p className="section-p">Explore our multiple hostels with modern amenities and comfortable living spaces.</p>
          </div>
              ...
              >
                ...
                <div className="hostel-card-body">
                  ...
                  <div className="hostel-card-location">
                    <MapPin size={12} /> {hostel.location} • {hostel.distance}
                  </div>
                  <div className="hostel-card-stats">
                    <div className="hostel-card-stat">
                      <Users size={12} /> {hostel.currentOccupancy}/{hostel.capacity}
                    </div>
                    <div className="hostel-card-stat">
                      <Star size={12} fill="#d97706" color="#d97706" /> {hostel.rating} ({hostel.reviews})
                    </div>
                  </div>
                  <div className="hostel-card-progress">
                    <div
                      className="hostel-card-progress-fill"
                      style={{ width: `${(hostel.currentOccupancy / hostel.capacity) * 100}%` }}
                    />
                  </div>
                  <div className="hostel-card-footer">
                    <span className="hostel-card-price">{hostel.priceRange}</span>
                    <span className="hostel-card-link">View Details <ArrowRight size={12} /></span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div style={{ textAlign: 'center', marginTop: '40px' }}>
            <Link to="/hostels" className="btn-pill" style={{ padding: '12px 32px' }}>
              View All Hostels <ArrowRight size={16} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <div className="cta-inner">
          ...
          <div className="cta-btns">
            <Link to="/register" className="cta-btn-p">Start Free Trial</Link>
            <Link to="/contact" className="cta-btn-s">Contact Sales</Link>
          </div>
        </div>
      </div>
